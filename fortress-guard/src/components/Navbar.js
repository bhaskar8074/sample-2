      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex flex-grow justify-end items-center space-x-4">
            <a href="#home" className="text-white hover:text-teal-400 transition-colors duration-300">Home</a>
            <a href="#features" className="text-white hover:text-teal-400 transition-colors duration-300">Features</a>
            <a href="#signup"
