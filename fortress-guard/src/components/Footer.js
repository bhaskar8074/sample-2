    ...
    <footer className="bg-gray-900 text-gray-300 py-8">
      <div className="container mx-auto px-4 md:px-8 lg:px-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#terms" className="hover:text-teal-400 transition-colors duration-300">Terms and Conditions</a></li>
            </ul>
          </div>
        ...
        <div className="mt-8 border-t border-gray-700 pt-4 text-center text-gray-500">
          &copy; {new Date().getFullYear()} FortressGuard. All rights reserved. <a href="#terms" className="hover:text-teal-400 transition-colors duration-300">Terms of Service</a>
        </div>
      </div>
    </footer>
  );
